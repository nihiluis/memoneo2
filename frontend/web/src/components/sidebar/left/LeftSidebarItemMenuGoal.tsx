...
import { LeftSidebarItemMenuDeleteGoalMutation } from "./__generated__/LeftSidebarItemMenuDeleteGoalMutation.graphql"
...
export default function LeftSidebarItemMenuGoal(props: Props) {
  return (
    <Suspense fallback={null}>
      <LeftSidebarItemMenuGoalInner {...props} />
    </Suspense>
  )
}

function LeftSidebarItemMenuGoalInner(props: Props): JSX.Element {
  ...
  const [commitDelete] = useMutation<LeftSidebarItemMenuDeleteGoalMutation>(
    deleteGoalMutation
  )
  ...
  const onDelete = useCallback(() => {
    ...
    const mutationConfig = getMutationConfig<LeftSidebarItemMenuDeleteGoalMutation>(
      variables,
      {
        setErrors: value => {
  ...
  }, [item.id, setLoading, setErrors, defaultGoalFilters, commitDelete])
